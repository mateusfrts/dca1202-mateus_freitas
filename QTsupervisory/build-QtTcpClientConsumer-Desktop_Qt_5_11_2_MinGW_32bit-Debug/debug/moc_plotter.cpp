...
QT_MOC_LITERAL(1, 8, 12), // "receberdados"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 13), // "vector<float>"
QT_MOC_LITERAL(4, 36, 6), // "valor_"
QT_MOC_LITERAL(5, 43, 6) // "tempo_"

    },
    "Plotter\0receberdados\0\0vector<float>\0"
    "valor_\0tempo_"
};
...
void Plotter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receberdados((*reinterpret_cast< vector<float>(*)>(_a[1])),(*reinterpret_cast< vector<float>(*)>(_a[2]))); break;
        default: ;
        }
    }
}
